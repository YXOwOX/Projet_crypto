...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('+2JCF-bL3x', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('opAhiCfVuc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\CryptocurrencyRepository' => ['privates', 'App\\Repository\\CryptocurrencyRepository', 'getCryptocurrencyRepositoryService', false],
            ...
            'App\\Repository\\CryptocurrencyRepository' => '?',
    ...
    /**
     * Gets the private 'App\Repository\CryptocurrencyRepository' shared autowired service.
     *
     * @return \App\Repository\CryptocurrencyRepository
     */
    protected function getCryptocurrencyRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CryptocurrencyRepository.php';

        return $this->privates['App\\Repository\\CryptocurrencyRepository'] = new \App\Repository\CryptocurrencyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n6fKd+faAf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eVziQTRySO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aNjLKoKlkB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2yUQSt8SpG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j7P0o+Bi55', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderca491 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerfe031 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesde48b = [
        
    ];

    public function getConnection()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getConnection', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getMetadataFactory', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getExpressionBuilder', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'beginTransaction', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getCache', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getCache();
    }

    public function transactional($func)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'transactional', array('func' => $func), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->transactional($func);
    }

    public function commit()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'commit', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->commit();
    }

    public function rollback()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'rollback', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getClassMetadata', array('className' => $className), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'createQuery', array('dql' => $dql), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'createNamedQuery', array('name' => $name), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'createQueryBuilder', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'flush', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'clear', array('entityName' => $entityName), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->clear($entityName);
    }

    public function close()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'close', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->close();
    }

    public function persist($entity)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'persist', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'remove', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'refresh', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'detach', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'merge', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getRepository', array('entityName' => $entityName), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'contains', array('entity' => $entity), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getEventManager', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getConfiguration', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'isOpen', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getUnitOfWork', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getProxyFactory', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'initializeObject', array('obj' => $obj), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'getFilters', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'isFiltersStateClean', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'hasFilters', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return $this->valueHolderca491->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerfe031 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderca491) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderca491 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderca491->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, '__get', ['name' => $name], $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        if (isset(self::$publicPropertiesde48b[$name])) {
            return $this->valueHolderca491->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderca491;
    ...
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;
    ...
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, '__isset', array('name' => $name), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;
    ...
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, '__unset', array('name' => $name), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;
    ...
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, '__clone', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        $this->valueHolderca491 = clone $this->valueHolderca491;
    }

    public function __sleep()
    {
        $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, '__sleep', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;

        return array('valueHolderca491');
    }
    ...
    {
        $this->initializerfe031 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerfe031;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerfe031 && ($this->initializerfe031->__invoke($valueHolderca491, $this, 'initializeProxy', array(), $this->initializerfe031) || 1) && $this->valueHolderca491 = $valueHolderca491;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderca491;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderca491;
    }
}
